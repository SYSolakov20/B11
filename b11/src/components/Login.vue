  ...
  <div class="register-wrapper">
    <div class="register">
      <div class="register__left-section">
        <div class="register__left-section__inner">
          <p class="left-section__inner__title">B11</p>
          <p class="left-section__inner__title">Online</p>
          <p class="left-section__inner__title">Marketplace</p>
          <p class="left-section__inner__text">
            Sign in to get the full experiance of your great application, don't forget you can
            always register.
          </p>
        </div>
      </div>
...
@font-face {
  font-family: 'Tex';
  src: url(../assets/fonts/tex-gyre-adventor.bold.ttf);
}
...
.register {
  ...
  width: 1180px;
  height: 711px;
  box-shadow: (6px 6px 35px rgba(17, 67, 79, 0.25));
}
...
.register__right-section__inner {
  display: flex;
  flex-direction: column;
  margin-left: 65px;
  width: 520px;
...
.submit-button {
  width: 190px;
  height: 45px;
  background-color: rgba(225, 230, 224, 1);
  color: black;
  border: none;
  font-family: 'Inter';
  font-size: 16px;
...
Pricing API Training Blog About Neos/LoginSection.vue at main · ZYPetkova20/Neos
